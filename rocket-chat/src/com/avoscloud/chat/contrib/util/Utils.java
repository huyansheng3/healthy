...
public class Utils {
  ...
  public static void toast(int id) {
    toast(ChatService.ctx, id);
  }

  public static void toast(String s) {
    toast(ChatService.ctx, s);
  }

  public static void toast(String s, String exceptionMsg) {
    if (ChatService.isDebug()) {
      s = s + exceptionMsg;
    }
    toast(s);
  }
  ...
  public static void toast(int resId, String exceptionMsg) {
    String s = ChatService.ctx.getString(resId);
  ...
  public static ProgressDialog showSpinnerDialog(Activity activity) {
    ...
    dialog.setMessage(ChatService.ctx.getString(R.string.hardLoading));
  ...
  public static int getColor(int resId) {
    return ChatService.ctx.getResources().getColor(resId);
  }
  ...
  public static String getPrettyDistance(double distance) {
    if (distance < 1000) {
      ...
      return String.valueOf(metres) + ChatService.ctx.getString(R.string.metres);
    } else {
      String num = String.format("%.1f", distance / 1000);
      return num + ChatService.ctx.getString(R.string.kilometres);
    }
  }
