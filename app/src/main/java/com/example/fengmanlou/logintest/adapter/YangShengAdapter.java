 ...
 */
public class YangShengAdapter extends BaseAdapter{
    private Context context;
    private volatile List<Healthy> healthyList;

    public YangShengAdapter() {
    }
    ...
    public YangShengAdapter(Context context, List<Healthy> healthyList) {
        this.context = context;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        View view;
        if (convertView == null){
            view = LayoutInflater.from(context).inflate(R.layout.yansheng_item,null);
        }else {
            view = convertView;
        }
