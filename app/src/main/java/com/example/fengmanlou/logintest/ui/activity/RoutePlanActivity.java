...
public class RoutePlanActivity extends Activity implements BaiduMap.OnMapClickListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MapStatusUpdate u = MapStatusUpdateFactory.newLatLng(new LatLng(34.128487,108.836995));
    ...
    public void SearchButtonProcess(View v) {
        ...
        PlanNode stNode = PlanNode.withCityNameAndPlaceName("西安", editSt.getText().toString());
        PlanNode enNode = PlanNode.withCityNameAndPlaceName("西安", editEn.getText().toString());
